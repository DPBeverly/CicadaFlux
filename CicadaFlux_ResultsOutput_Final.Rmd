...
# Load the shapefiles
#Collar Shapefiles
MMSF_pheno <- readOGR(project_dir, layer="PhenoHoles_MMSF_v2") 
...
dir()
##//Clipped .img files in working directories and update data pathways
##//Mean Flux estimate
SoilFlux_File <- file.path(project_dir, 
                        "Clipped_soil_respiration_mean_eastern_US.img")
SoilFlux <- read_stars(SoilFlux_File)

##//25th Percentile 
SoilFlux_25_File <- file.path(project_dir, 
                        "Clipped_soil_respiration_Q25_eastern_US.img")
SoilFlux_25 <- read_stars(SoilFlux_25_File)

##//75th Percentile 
SoilFlux_75_File <- file.path(project_dir, 
                        "Clipped_soil_respiration_Q75_eastern_US.img")
SoilFlux_75 <- read_stars(SoilFlux_75_File)
...
summary(fit_hole2x, prob = 0.89)
bayes_R2(fit_hole2x, prob = c(0.055, 0.945))
