...
# TS_mod1x <- brm(
#     SoilT_C ~ Week,
#     data = Rs_plots[Rs_plots$Corr_LinFlux<=6,],
#     prior = my.prior,
#     family =  "normal",
#     seed = 12345, 
#     iter = 2000,
...
# bayes_R2(TS_mod1x, prob = c(0.03, 0.97))
...
# bayes_R2(SM_mod1x, prob = c(0.03, 0.97))
...
# bayes_R2(TS_mod2x, prob = c(0.03, 0.97))
...
# bayes_R2(SM_mod2x, prob = c(0.03, 0.97))
...
# ##// Uncomment to view model summaries and plots 
# summary(Rs_mod1x, prob = 0.94)
# bayes_R2(Rs_mod1x, prob = c(0.03, 0.97))
...
# 
# ##// Uncomment to view model summaries and plots 
# summary(Rs_mod3x, prob = 0.94)
# bayes_R2(Rs_mod3x, prob = c(0.03, 0.97))
...
# ##//AmeriFlux download for local machine linked to my personal dropbox
# ##//Update teh file path to match local pathways
AmeriFlux_File <- "D:/Dropbox/Projects/Indiana/Data/CicadaFlux/AMF_US-MMS_BASE-BADM_21-5/AMF_US-MMS_BASE_HR_21-5.csv"
dat_46m <- read.csv(AmeriFlux_File,
                    skip = 2, na.strings = -9999)
